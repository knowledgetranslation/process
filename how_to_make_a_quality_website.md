...
[^1]: “Do not use frames. Many mobile devices do not support frames. In addition, frames are recognized as being generally problematic.” –Rabin Jo, McCathieNevile Charles (eds.), 2008. *Mobile Web Best Practices 1.0 Basic Guidelines*. W3C Recommendation 29 July 2008. [http://www.w3.org/TR/mobile-bp/#NO_FRAMES](http://www.w3.org/TR/mobile-bp/#NO_FRAMES). Accessed 2014-07-29.
...
[^44]: “Create documents that validate to published formal grammars. If the page markup is invalid this will result in unpredictable and possibly incomplete presentation.” –Rabin Jo, McCathieNevile Charles (eds.), 2008. *Mobile Web Best Practices 1.0 Basic Guidelines*. W3C Recommendation 29 July 2008. [http://www.w3.org/TR/mobile-bp/#VALID_MARKUP](http://www.w3.org/TR/mobile-bp/#VALID_MARKUP). Accessed 2014-07-29.
